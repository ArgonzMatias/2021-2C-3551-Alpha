...
namespace TGC.MonoGame.TP
{
    ...
    public class TGCGame : Game
    {
        ...
        public Matrix SunWorld { get; set; }
        ...
        public interface IModifier
    {
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            var sunPosition = new Vector3((float) Math.Cos(totalGameTime) * 100f, 500f, (float) Math.Sin(totalGameTime) * 100f);
            SunWorld = Matrix.CreateTranslation(sunPosition);
        ...
        protected override void Draw(GameTime gameTime)
        {
           ...
           // DrawShadows();
            ...
            DrawMeshes((Matrix.CreateScale(1)*Matrix.CreateTranslation(new Vector3(0,10,0))),MagmaTexture, Esfera);
            ...
            //Nivel 1
            //Principio /
            DrawMeshes(Matrix.CreateScale(2),LavaTexture, Esfera);
        ...
        {
            if (MarbleSphere.Position.Y < -20f || (TocandoLava && MarbleTexture != StoneTexture) )
            {
